...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager defaultWebSecurityManager){
        ...
        ruleMap.put("/user/**", "anon"); //登录路径、注册路径都需要放行不进行拦截
        ruleMap.put("/user/findEditor", "anon"); //登录路径、注册路径都需要放行不进行拦截
        ruleMap.put("/pub/files", "anon"); //公共文件查询都需要放行不进行拦截
        ruleMap.put("/source", "anon"); //在线播放都需要放行不进行拦截
        ruleMap.put("/search/**", "anon"); //搜索都需要放行不进行拦截
        ruleMap.put("/blog/**", "anon"); //搜索都需要放行不进行拦截
        ruleMap.put("/tag/**", "anon"); //搜索都需要放行不进行拦截
